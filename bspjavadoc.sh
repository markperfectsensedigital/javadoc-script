...
CLASSPATH=$M2PATH/.m2/repository/com/google/guava/guava/21.0/guava-21.0.jar:$M2PATH/.m2/repository/org/apache/commons/commons-lang3/3.2.1/commons-lang3-3.2.1.jar:$M2PATH/.m2/repository/commons-lang/commons-lang/2.4/commons-lang-2.4.jar:$M2PATH/.m2/repository/com/psddev/dari-util/3.3.92-116cf8/dari-util-3.3.92-116cf8.jar:$M2PATH/.m2/repository/javax/servlet/javax.servlet-api/3.0.1/javax.servlet-api-3.0.1.jar:$M2PATH/.m2/repository/org/slf4j/slf4j-api/1.7.6/slf4j-api-1.7.6.jar:$M2PATH/.m2/repository/javax/servlet/jsp/javax.servlet.jsp-api/2.3.1/javax.servlet.jsp-api-2.3.1.jar:$M2PATH/.m2/repository/javax/servlet/javax.servlet-api/3.1.0/javax.servlet-api-3.1.0.jar:$M2PATH/.m2/repository/com/psddev/dari-asm/3.3.143-1c7d90/dari-asm-3.3.143-1c7d90.jar:$M2PATH/.m2/repository/com/google/code/findbugs/jsr305/3.0.0/jsr305-3.0.0.jar:$M2PATH/.m2/repository/com/psddev/dari-reflections/3.3.143-1c7d90/dari-reflections-3.3.143-1c7d90.jar:$M2PATH/.m2/repository/joda-time/joda-time/2.2/joda-time-2.2.jar:$M2PATH/.m2/repository/com/cronutils/cron-utils/6.0.1/cron-utils-6.0.1.jar:$M2PATH/.m2/repository/org/threeten/threetenbp/1.3.2/threetenbp-1.3.2.jar:$M2PATH/.m2/repository/org/jsoup/jsoup/1.10.3/jsoup-1.10.3.jar:$M2PATH/.m2/repository/com/fasterxml/jackson/core/jackson-core/2.9.2/jackson-core-2.9.2.jar:$M2PATH/.m2/repository/commons-fileupload/commons-fileupload/1.2.1/commons-fileupload-1.2.1.jar:$M2PATH/.m2/repository/commons-fileupload/commons-fileupload/1.2.1/commons-fileupload-1.2.1.jar:$M2PATH/.m2/repository/com/psddev/dari-db/3.3-SNAPSHOT/dari-db-3.3-SNAPSHOT.jar:$M2PATH/.m2/repository/com/psddev/cms-db/3.3-SNAPSHOT/cms-db-3.3-SNAPSHOT.jar:$M2PATH/.m2/repository/com/psddev/dari-util/3.3-SNAPSHOT/dari-util-3.3-SNAPSHOT.jar
...
javadoc -d $OUTPUTDIRECTORY -sourcepath $SOURCEPATH -public -charset "UTF-8" -classpath $CLASSPATH -link https://docs.oracle.com/javase/8/docs/api/ -link https://commons.apache.org/proper/commons-lang/javadocs/api-3.6/ -link https://commons.apache.org/proper/commons-lang/javadocs/api-2.6/ -doctitle "$DOCTITLE" -windowtitle "$WINDOWTITLE" $TARGET
